...
RSpec.describe MyGit::Lint::Commits::Loader do
  ...
  before { MyGit::Lint::Commits::Systems::Import.stub repository:, environment: }

  after { MyGit::Lint::Commits::Systems::Import.unstub :repository, :environment }

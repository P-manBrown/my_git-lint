...
RSpec.describe MyGit::Lint::CLI::Actions::Analyze::Commit do
  ...
  describe "#call" do
    ...
    context "with failure" do
      ...
      let(:analyzer) { instance_double MyGit::Lint::Analyzer }

      before { allow(analyzer).to receive(:call).and_raise(MyGit::Lint::Errors::Base, "Danger!") }

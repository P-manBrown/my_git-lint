...
RSpec.describe MyGit::Lint::CLI::Shell do
  ...
  before { MyGit::Lint::CLI::Actions::Import.stub configuration:, kernel:, logger: }

  after { MyGit::Lint::CLI::Actions::Import.unstub :configuration, :kernel, :logger }

...
RSpec.describe MyGit::Lint::Reporters::Branch do
  subject(:reporter) { described_class.new collector: }

  include_context "with Git commit"

  let(:collector) { MyGit::Lint::Collector.new }

  describe "#to_s" do
    let :analyzer do
      instance_spy MyGit::Lint::Analyzers::CommitAuthorEmail,
                   class: class_spy(
                     MyGit::Lint::Analyzers::CommitAuthorEmail,

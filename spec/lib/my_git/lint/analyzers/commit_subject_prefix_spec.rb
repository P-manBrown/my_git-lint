...
RSpec.describe MyGit::Lint::Analyzers::CommitSubjectPrefix do
  ...
  describe "#valid?" do
    ...
    context "with custom include list" do
      ...
      let :configuration do
        MyGit::Lint::Configuration::Content[
          analyzers: [
            MyGit::Lint::Configuration::Setting[id: :commit_subject_prefix, includes: %w[One Two]]
          ]
        ]
      end
    ...
    context "with empty include list" do
      ...
      let :configuration do
        MyGit::Lint::Configuration::Content[
          analyzers: [
            MyGit::Lint::Configuration::Setting[id: :commit_subject_prefix, includes: []]
          ]
        ]
      end

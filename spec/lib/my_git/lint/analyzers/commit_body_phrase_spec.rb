...
RSpec.describe MyGit::Lint::Analyzers::CommitBodyPhrase do
  ...
  describe "#valid?" do
    ...
    context "with excluded word (mixed case)" do
      ...
      let :configuration do
        MyGit::Lint::Configuration::Content[
          analyzers: [
            MyGit::Lint::Configuration::Setting[id: :commit_body_phrase, excludes: ["BasicaLLy"]]
          ]
        ]
      end
    ...
    context "with excluded phrase (mixed case)" do
      ...
      let :configuration do
        MyGit::Lint::Configuration::Content[
          analyzers: [
            MyGit::Lint::Configuration::Setting[id: :commit_body_phrase, excludes: ["OF CoursE"]]
          ]
        ]
      end
    ...
    context "with excluded boundary word (regular expression)" do
      ...
      let :configuration do
        MyGit::Lint::Configuration::Content[
          analyzers: [
            MyGit::Lint::Configuration::Setting[id: :commit_body_phrase, excludes: ["\\bjust\\b"]]
          ]
        ]
      end
    ...
    context "with excluded phrase (regular expression)" do
      ...
      let :configuration do
        MyGit::Lint::Configuration::Content[
          analyzers: [
            MyGit::Lint::Configuration::Setting[
